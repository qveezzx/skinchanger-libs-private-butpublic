...
void RenderMenu()
{
    ...
    static std::vector<std::string> titles = {
        "VAC_TESTER", "PROJECT_KAMI", "CS2_SKINS", "BOT_TEST_ONLY", "ED_PURPOSES"
    };
    ...
    SC_GUI::DrawGlow(x + 30, y + 20, 150, 40, 4, SC_GUI::currentTheme.accent, 10);
    SC_GUI::DrawStringA(titles[titleIdx], x + 35, y + 25, SC_GUI::currentTheme.text, SC_GUI::largeFont, false);
    
    // Subtitle
    SC_GUI::DrawStringA("External Skin Changer v2.1", x + 35, y + 55, SC_GUI::currentTheme.textDim, SC_GUI::smallFont, false);
